...
Public Class LaporanDataSuplier
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PenjualanTokoSepatu.LaporanDataSuplier.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLaporanDataSuplier
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LaporanDataSuplier = New LaporanDataSuplier()
        rpt.Site = Me.Site
        Return rpt
    End Function
