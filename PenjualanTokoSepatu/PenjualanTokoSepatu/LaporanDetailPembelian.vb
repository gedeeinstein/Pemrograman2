...
Public Class LaporanDetailPembelian
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PenjualanTokoSepatu.LaporanDetailPembelian.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLaporanDetailPembelian
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LaporanDetailPembelian = New LaporanDetailPembelian()
        rpt.Site = Me.Site
        Return rpt
    End Function
