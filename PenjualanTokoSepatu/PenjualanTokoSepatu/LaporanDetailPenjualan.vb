...
Public Class LaporanDetailPenjualan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PenjualanTokoSepatu.LaporanDetailPenjualan.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLaporanDetailPenjualan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LaporanDetailPenjualan = New LaporanDetailPenjualan()
        rpt.Site = Me.Site
        Return rpt
    End Function
