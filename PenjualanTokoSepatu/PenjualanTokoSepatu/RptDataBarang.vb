...
Public Class RptDataBarang
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PenjualanTokoSepatu.RptDataBarang.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptDataBarang
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptDataBarang = New RptDataBarang()
        rpt.Site = Me.Site
        Return rpt
    End Function
