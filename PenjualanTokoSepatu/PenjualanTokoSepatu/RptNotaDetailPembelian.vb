...
Public Class RptNotaDetailPembelian
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RptNotaDetailPembelian.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PenjualanTokoSepatu.RptNotaDetailPembelian.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_pmNoTrxPembelian() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRptNotaDetailPembelian
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptNotaDetailPembelian = New RptNotaDetailPembelian()
        rpt.Site = Me.Site
        Return rpt
    End Function
