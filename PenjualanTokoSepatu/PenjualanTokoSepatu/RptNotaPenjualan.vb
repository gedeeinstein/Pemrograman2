...
Public Class RptNotaPenjualan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PenjualanTokoSepatu.RptNotaPenjualan.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_pmKodeTransaksi() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRptNotaPenjualan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptNotaPenjualan = New RptNotaPenjualan()
        rpt.Site = Me.Site
        Return rpt
    End Function
